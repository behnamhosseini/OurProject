        ...
        <div class="col-xl-9 order-xl-2 col-lg-9 order-lg-2 col-md-12 order-md-1 col-sm-12 col-xs-12">
            <div class="ui-block">
                <div class="ui-block-title">
                    <h6 class="title">تغییر رمز عبور</h6>
                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group label-floating">
                                    <label class="control-label">تایید گذرواژه فعلی</label>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label">گذرواژه جدید</label>
                                    <input name="newPassword" class="form-control" placeholder="" type="password">
                                    <span class="material-input"></span></div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label">تایید گذرواژه جدید</label>
                                    <input name="newPassword_confirmation" class="form-control" placeholder=""
                                           type="password">
                                    <span class="material-input"></span></div>
                            </div>
                            ...
                            <div class="col-lg-12 col-sm-12 col-sm-12 col-xs-12">
                                {{--<div class="remember">--}}
                                    ...
                                    {{--<div class="checkbox">--}}
                                        {{--<label>--}}
                                            {{--مرا به خاطر بسپار--}}
                                            {{--<input name="optionsCheckboxes" type="checkbox"><span class="check"></span>--}}
                                        {{--</label>--}}
                                    {{--</div>--}}
                                    {{--<br>--}}
                                ...
                                <div class="my-3">
                                    <a href="/password/reset" class="forgot">رمز عبورمو فراموش کردم!</a>
                                </div>
                            </div>

                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <button class="btn btn-primary btn-lg full-width">رمز عبور را تغییر بده</button>
                            </div>
