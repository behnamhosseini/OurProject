    ...
    <div class="row">
        ...
        <div class="ui-block">
            <div class="ui-block-title">
                <h6 class="title">سوابق تحصیلی شما</h6>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group label-floating">
                                ...
                                <input class="form-control" placeholder="" type="text" value="کارشناسی نرم افزار">
                                <span class="material-input"></span></div>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group label-floating">
                                ...
                                <textarea class="form-control" placeholder="">دانشجوی کامپیوتر گرایش نرم افزار
								</textarea>
                                <span class="material-input"></span></div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <button class="btn btn-primary btn-lg full-width">ذخیره تغییرات</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="ui-block">
            <div class="ui-block-title">
                <h6 class="title">سوابق کاری شما</h6>
            </div>
            <div class="ui-block-content">
                <form>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group label-floating">
                                <label class="control-label">عنوان مکان</label>
                                <input class="form-control" placeholder="" type="text" value="دیجیتال مارکتینگ">
                                <span class="material-input"></span></div>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group label-floating">
                                <label class="control-label">توضیحات</label>
                                <textarea class="form-control" placeholder="">توضیحات در این قسمت
								</textarea>
                                <span class="material-input"></span></div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group label-floating">
                                <label class="control-label">عنوان محل کار</label>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group label-floating">
                                <label class="control-label">توضیحات</label>
                                <textarea class="form-control" placeholder="">UI and UI supervisor
								</textarea>
                                <span class="material-input"></span></div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group label-floating is-empty">
                                <label class="control-label">عنوان مکان شما</label>
                                <input class="form-control" placeholder="" type="text">
                                <span class="material-input"></span></div>
                        </div>
